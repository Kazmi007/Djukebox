...
enum SubscriptionPlan {free_of_charge, premium};  // Definition of two different subscription plans.
...
private:
    ...
    LinkedList<Playlist> playlists;  // Profile playlists stored as a linked list of playlists. 
    LinkedList<Profile *> following;  // Profile following stored as a linked list of profile pointers.
    LinkedList<Profile *> followers;  // Profile followers stored as a linked list of profile pointers.
};
